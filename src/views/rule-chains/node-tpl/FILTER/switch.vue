<template>
  <el-form ref="form" :model="form" :rules="rules">
    ...
    <el-form-item label="开关" prop="jsScript" class="switch-container">
    ...
    <wx-button type="primary" @click="test">测试开关功能</wx-button>
...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      const defaultJsScript = 'function nextRelation(metadata, msg) {\n    return ["one", "nine"];\n}\nif(msgType === "POST_TELEMETRY_REQUEST") {\n    return ["two"];\n}\nreturn nextRelation(metadata, msg);'
      const { description } = this.nodeInfo.additionalInfo || {}
      this.form = {
        name: name || '',
        debugMode: debugMode || false,
        jsScript: JSON.stringify(this.nodeInfo) === '{}' ? jsScript || defaultJsScript : jsScript,
