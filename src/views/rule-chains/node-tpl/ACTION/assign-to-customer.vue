...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      const { customerNamePattern, customerCacheExpiration, createCustomerIfNotExists } = this.nodeInfo.configuration || {}
      ...
      this.form = {
        ...
        customerNamePattern,
        customerCacheExpiration,
        createCustomerIfNotExists: createCustomerIfNotExists || false
      }
